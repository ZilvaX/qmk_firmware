...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LL_BSPC, KC_SPC,  KC_SPC,  RL_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, MO_ADJ,  KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY  \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  KC_ESC,  _______, _______, _______,  _______, _______, _______, KC_INS,  KC_HOME, KC_PGUP, _______, _______, \
  ...
  _______, _______, _______, _______,  MO_ADJ,  _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY  \
),
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|  FPS |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  FPS,     _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        ...
        case FPS:
          if (record->event.pressed) {
            set_single_persistent_default_layer(_FPS);
          }
          return false;
          break;
        case LOWER:
