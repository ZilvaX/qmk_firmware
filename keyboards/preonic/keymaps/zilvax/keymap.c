 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |EscCtl|   A  |   S  |D|Alt |F|GUI |   G  |   H  |J|RGUI|K|RAlt|   L  |   ;  |  '   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  ESC_CTL, KC_A,    KC_S,    ALT_T(KC_D),GUI_T(KC_F),   KC_G,    KC_H,    RGUI_T(KC_J),RALT_T(KC_K), KC_L,    KC_SCLN, KC_QUOT, \
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, RESET,   DEBUG,   _______, _______, CG_NORM, CG_SWAP, TERM_ON, TERM_OFF,_______, _______, KC_DEL,  \
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,    GAME,  _______, _______,\
